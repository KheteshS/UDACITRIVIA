...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format('postgres','postgres410','localhost:5432',self.database_name)
    ...
    def test_404_delete_question(self):
        result = self.client().delete('/questions/90')
        data = json.loads(result.data)
    ...
    def test_post_new_question(self):
        ...
        result = self.client().post('/questions', json=post_data)
        data = json.loads(result.data)
    ...
    def test_post_paginated_search_questions(self):
        ...
        result = self.client().post('/searchQuestions', json=post_data)
        data = json.loads(result.data)
    ...
    def test_404_post_paginated_search_questions_beyond_valid_page(self):
        ...
        result = self.client().post('/searchQuestions?page=100', json=post_data)
        data = json.loads(result.data)
    ...
    def test_422_post_paginated_search_questions(self):
        result = self.client().post('/searchQuestions')
        data = json.loads(result.data)
    ...
    def test_get_paginated_question_by_category(self):
        result = self.client().get('/categories/1/questions?page=1')
        data = json.loads(result.data)
    ...
    def test_404_get_paginated_question_by_category_beyond_valid_page(self):
        result = self.client().get('/categories/1/questions?page=100')
        data = json.loads(result.data)
    ...
    def test_post_play_quiz(self):
        ...
        result = self.client().post('/quizzes', json=post_data)
        data = json.loads(result.data)
